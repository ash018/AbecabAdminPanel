                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <form role="form" action="<?php echo base_url() ?>UserManager/userSave" method="post">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                                            <label>Selects Role</label>
                                                            <select class="form-control" id="RoleId" name="RoleId"  required="True">
                                                                <option value="0" <?php if($roleId == 0){echo 'selected="selected"';}?> >Select</option>
                                                                <?php foreach ($roles as $r) { ?>
                                                                    <option value="<?php echo $r['RoleId']; ?>" <?php if($roleId != 0 && $roleId == $r['RoleId']){echo 'selected="selected"';}?>><?php echo $r['RoleName']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
